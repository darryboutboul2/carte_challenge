              ...
              <View style={styles.cardHeader}>
                <View style={styles.memberInfo}>
                  ...
                  <View style={styles.levelBadge}>
                    <LinearGradient colors={levelColors} style={styles.levelGradient}>
                      <Text style={styles.levelEmoji}>{getMemberLevelEmoji(activeMember.level)}</Text>
...
const styles = StyleSheet.create({
  ...
  levelBadge: { alignSelf: 'flex-start', borderRadius: 20, overflow: 'hidden' },
  levelGradient: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, gap: 6 },
